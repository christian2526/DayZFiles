...
// There is also "Hero2_DZC_TEST" and Bandit2_DZC_TEST which seems not to be used for now
	if (!(_model in ["SurvivorW2_DZ","Rocker1","RUS_Soldier1","GUE_Soldier_2","CDF_Soldier_Light","US_Delta_Force_M14_EP1","UN_CDF_Soldier_EP1","FR_Light","Survivor2_DZ","Survivor3_DZ","Sniper1_DZ","Soldier1_DZ","Camo1_DZ","Bandit1_DZ","Rocket_DZ"])) then {
		_model = ["Rocker1","RUS_Soldier1","GUE_Soldier_2","UN_CDF_Soldier_EP1","CDF_Soldier_Light"] select floor random 5;
	};
